...
$items = modDJLeagueScheduleHelper::getItems($params);
...
$layout = explode(':',$params->get('layout','default'));
$layout = (isset($layout[1]) ? $layout[1] : $layout[0]);

if($layout == 'counter') {
	$doc->addScript(JURI::root(true).'/modules/mod_djleague_schedule/assets/js/counter.js');
}

require JModuleHelper::getLayoutPath('mod_djleague_schedule', $params->get('layout','default'));
